...
proc displayHelp*(args: seq[string] = @[]) =
  ...
  of "l", "list":
    ...
    t.write(5, true, fgCyan, "help")
    t.write(30, fgWhite, "Display this message.", "\n")
    ...
    t.write(5, true, fgCyan, "pin <ids>")
    t.write(30, fgWhite, "Pin addon to current version. Addon will not be updated until unpinned.", "\n")
